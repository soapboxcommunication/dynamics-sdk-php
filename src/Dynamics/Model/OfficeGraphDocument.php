...
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class OfficeGraphDocument extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'officegraphdocuments';
     ...
     * @var string
     */
    protected $primaryKey = 'officegraphdocumentid';
}
