...
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class SdkMessageProcessingStep extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'sdkmessageprocessingsteps';
     ...
     * @var string
     */
    protected $primaryKey = 'sdkmessageprocessingstepid';
}
