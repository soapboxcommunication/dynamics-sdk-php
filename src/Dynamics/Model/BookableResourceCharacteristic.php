...
*
* BookableResourceCharacteristic File
* PHP version 7
*
* @category  Library
...
/**
* BookableResourceCharacteristic class
*
* BookableResourceCharacteristic entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class BookableResourceCharacteristic extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'bookableresourcecharacteristics';
     ...
     * @var string
     */
    protected $primaryKey = 'bookableresourcecharacteristicid';
}
