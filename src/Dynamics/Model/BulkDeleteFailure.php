...
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class BulkDeleteFailure extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'bulkdeletefailures';
     ...
     * @var string
     */
    protected $primaryKey = 'bulkdeletefailureid';
}
