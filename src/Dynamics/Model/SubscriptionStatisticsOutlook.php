...
*
* SubscriptionStatisticsOutlook File
* PHP version 7
*
* @category  Library
...
/**
* SubscriptionStatisticsOutlook class
*
* SubscriptionStatisticsOutlook entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class SubscriptionStatisticsOutlook extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'subscriptionstatisticsoutlookset';
