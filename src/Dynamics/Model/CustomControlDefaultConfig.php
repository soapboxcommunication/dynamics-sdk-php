...
*
* CustomControlDefaultConfig File
* PHP version 7
*
* @category  Library
...
/**
* CustomControlDefaultConfig class
*
...
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class CustomControlDefaultConfig extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'customcontroldefaultconfigs';
     ...
     * @var string
     */
    protected $primaryKey = 'customcontroldefaultconfigid';
}
