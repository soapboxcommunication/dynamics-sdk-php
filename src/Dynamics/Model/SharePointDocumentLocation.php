...
*
* SharePointDocumentLocation File
* PHP version 7
*
* @category  Library
...
/**
* SharePointDocumentLocation class
*
...
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class SharePointDocumentLocation extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'sharepointdocumentlocations';
     ...
     * @var string
     */
    protected $primaryKey = 'sharepointdocumentlocationid';
}
