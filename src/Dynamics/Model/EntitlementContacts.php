...
/**
* EntitlementContacts class
*
* EntitlementContacts entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class EntitlementContacts extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'entitlementcontactscollection';
     ...
     * @var string
     */
    protected $primaryKey = 'entitlementcontactid';
}
