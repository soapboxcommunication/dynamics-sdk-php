...
/**
* TimeZoneLocalizedName class
*
* TimeZoneLocalizedName entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class TimeZoneLocalizedName extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'timezonelocalizednames';
     ...
     * @var string
     */
    protected $primaryKey = 'timezonelocalizednameid';
}
