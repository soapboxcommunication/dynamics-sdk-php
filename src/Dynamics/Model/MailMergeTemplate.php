...
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class MailMergeTemplate extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'mailmergetemplates';
     ...
     * @var string
     */
    protected $primaryKey = 'mailmergetemplateid';
}
