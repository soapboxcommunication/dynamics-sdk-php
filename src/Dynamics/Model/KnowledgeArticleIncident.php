...
/**
* KnowledgeArticleIncident class
*
* KnowledgeArticleIncident entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class KnowledgeArticleIncident extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'knowledgearticleincidents';
     ...
     * @var string
     */
    protected $primaryKey = 'knowledgearticleincidentid';
}
