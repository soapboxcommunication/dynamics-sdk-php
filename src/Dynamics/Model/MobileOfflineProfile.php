...
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class MobileOfflineProfile extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'mobileofflineprofiles';
     ...
     * @var string
     */
    protected $primaryKey = 'mobileofflineprofileid';
}
