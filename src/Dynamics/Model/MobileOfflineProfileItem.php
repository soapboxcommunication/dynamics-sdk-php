...
/**
* MobileOfflineProfileItem class
*
...
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class MobileOfflineProfileItem extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'mobileofflineprofileitems';
     ...
     * @var string
     */
    protected $primaryKey = 'mobileofflineprofileitemid';
}
