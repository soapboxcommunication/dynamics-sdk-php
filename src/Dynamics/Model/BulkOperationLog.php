...
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class BulkOperationLog extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'bulkoperationlogs';
     ...
     * @var string
     */
    protected $primaryKey = 'bulkoperationlogid';
}
