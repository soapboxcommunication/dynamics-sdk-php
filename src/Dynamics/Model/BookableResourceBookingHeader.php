...
*
* BookableResourceBookingHeader File
* PHP version 7
*
* @category  Library
...
/**
* BookableResourceBookingHeader class
*
* BookableResourceBookingHeader entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class BookableResourceBookingHeader extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'bookableresourcebookingheaders';
     ...
     * @var string
     */
    protected $primaryKey = 'bookableresourcebookingheaderid';
}
