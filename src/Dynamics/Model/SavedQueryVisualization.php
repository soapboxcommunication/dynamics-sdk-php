...
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class SavedQueryVisualization extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'savedqueryvisualizations';
     ...
     * @var string
     */
    protected $primaryKey = 'savedqueryvisualizationid';
}
