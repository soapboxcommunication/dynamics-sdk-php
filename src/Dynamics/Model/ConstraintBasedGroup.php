...
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class ConstraintBasedGroup extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'constraintbasedgroups';
     ...
     * @var string
     */
    protected $primaryKey = 'constraintbasedgroupid';
}
