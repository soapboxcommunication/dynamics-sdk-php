...
*
* SystemUserSyncMappingProfiles File
* PHP version 7
*
* @category  Library
...
/**
* SystemUserSyncMappingProfiles class
*
* SystemUserSyncMappingProfiles entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class SystemUserSyncMappingProfiles extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'systemusersyncmappingprofilescollection';
     ...
     * @var string
     */
    protected $primaryKey = 'systemusersyncmappingprofileid';
}
