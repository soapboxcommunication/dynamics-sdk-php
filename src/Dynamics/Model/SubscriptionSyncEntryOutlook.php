...
*
* SubscriptionSyncEntryOutlook File
* PHP version 7
*
* @category  Library
...
/**
* SubscriptionSyncEntryOutlook class
*
* SubscriptionSyncEntryOutlook entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class SubscriptionSyncEntryOutlook extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'subscriptionsyncentriesoutlook';
