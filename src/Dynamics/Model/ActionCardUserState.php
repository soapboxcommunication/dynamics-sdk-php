...
/**
* ActionCardUserState class
*
* ActionCardUserState entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class ActionCardUserState extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'actioncarduserstates';
     ...
     * @var string
     */
    protected $primaryKey = 'actioncarduserstateid';
}
