...
/**
* PersonalDocumentTemplate class
*
* PersonalDocumentTemplate entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class PersonalDocumentTemplate extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'personaldocumenttemplates';
     ...
     * @var string
     */
    protected $primaryKey = 'personaldocumenttemplateid';
}
