...
*
* SdkMessageProcessingStepSecureConfig File
* PHP version 7
*
* @category  Library
...
/**
* SdkMessageProcessingStepSecureConfig class
*
* SdkMessageProcessingStepSecureConfig entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class SdkMessageProcessingStepSecureConfig extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'sdkmessageprocessingstepsecureconfigs';
     ...
     * @var string
     */
    protected $primaryKey = 'sdkmessageprocessingstepsecureconfigid';
}
