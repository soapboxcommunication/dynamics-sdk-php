...
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class CompetitorProduct extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'competitorproducts';
     ...
     * @var string
     */
    protected $primaryKey = 'competitorproductid';
}
