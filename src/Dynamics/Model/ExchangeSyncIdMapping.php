...
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class ExchangeSyncIdMapping extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'exchangesyncidmappings';
     ...
     * @var string
     */
    protected $primaryKey = 'exchangesyncidmappingid';
}
