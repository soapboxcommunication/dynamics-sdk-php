...
/**
* ServiceContractContacts class
*
* ServiceContractContacts entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class ServiceContractContacts extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'servicecontractcontactscollection';
     ...
     * @var string
     */
    protected $primaryKey = 'servicecontractcontactid';
}
