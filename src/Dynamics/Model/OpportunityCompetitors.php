...
/**
* OpportunityCompetitors class
*
* OpportunityCompetitors entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class OpportunityCompetitors extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'opportunitycompetitorscollection';
     ...
     * @var string
     */
    protected $primaryKey = 'opportunitycompetitorid';
}
