...
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class PublisherAddress extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'publisheraddresses';
     ...
     * @var string
     */
    protected $primaryKey = 'publisheraddressid';
}
