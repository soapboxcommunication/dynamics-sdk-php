...
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class InteractionForEmail extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'interactionforemails';
     ...
     * @var string
     */
    protected $primaryKey = 'interactionforemailid';
}
