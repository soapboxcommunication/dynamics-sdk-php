...
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class SalesLiteratureItem extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'salesliteratureitems';
     ...
     * @var string
     */
    protected $primaryKey = 'salesliteratureitemid';
}
