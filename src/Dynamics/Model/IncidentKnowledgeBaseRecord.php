...
*
* IncidentKnowledgeBaseRecord File
* PHP version 7
*
* @category  Library
...
/**
* IncidentKnowledgeBaseRecord class
*
* IncidentKnowledgeBaseRecord entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class IncidentKnowledgeBaseRecord extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'incidentknowledgebaserecords';
     ...
     * @var string
     */
    protected $primaryKey = 'incidentknowledgebaserecordid';
}
