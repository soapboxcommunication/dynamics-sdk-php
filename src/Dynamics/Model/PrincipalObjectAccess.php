...
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class PrincipalObjectAccess extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'principalobjectaccessset';
     ...
     * @var string
     */
    protected $primaryKey = 'principalobjectaccessid';
}
