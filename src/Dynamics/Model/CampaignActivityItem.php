...
/**
* CampaignActivityItem class
*
* CampaignActivityItem entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class CampaignActivityItem extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'campaignactivityitems';
     ...
     * @var string
     */
    protected $primaryKey = 'campaignactivityitemid';
}
