...
*
* SubscriptionStatisticsOffline File
* PHP version 7
*
* @category  Library
...
/**
* SubscriptionStatisticsOffline class
*
* SubscriptionStatisticsOffline entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class SubscriptionStatisticsOffline extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'subscriptionstatisticsofflineset';
