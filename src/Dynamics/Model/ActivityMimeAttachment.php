...
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class ActivityMimeAttachment extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'activitymimeattachments';
     ...
     * @var string
     */
    protected $primaryKey = 'activitymimeattachmentid';
}
