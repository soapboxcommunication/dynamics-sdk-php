...
/**
* KnowledgeArticleViews class
*
* KnowledgeArticleViews entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class KnowledgeArticleViews extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'knowledgearticleviews';
     ...
     * @var string
     */
    protected $primaryKey = 'knowledgearticleviewsid';
}
