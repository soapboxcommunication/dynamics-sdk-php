...
*
* ChannelAccessProfileEntityAccessLevel File
* PHP version 7
*
* @category  Library
...
/**
* ChannelAccessProfileEntityAccessLevel class
*
* ChannelAccessProfileEntityAccessLevel entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class ChannelAccessProfileEntityAccessLevel extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'channelaccessprofileentityaccesslevels';
     ...
     * @var string
     */
    protected $primaryKey = 'channelaccessprofileentityaccesslevelid';
}
