...
/**
* CustomControlResource class
*
* CustomControlResource entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class CustomControlResource extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'customcontrolresources';
     ...
     * @var string
     */
    protected $primaryKey = 'customcontrolresourceid';
}
