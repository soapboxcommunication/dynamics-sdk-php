...
*
* MobileOfflineProfileItemAssociation File
* PHP version 7
*
* @category  Library
...
/**
* MobileOfflineProfileItemAssociation class
*
* MobileOfflineProfileItemAssociation entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class MobileOfflineProfileItemAssociation extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'mobileofflineprofileitemassociations';
     ...
     * @var string
     */
    protected $primaryKey = 'mobileofflineprofileitemassociationid';
}
