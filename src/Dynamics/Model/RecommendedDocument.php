...
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class RecommendedDocument extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'recommendeddocuments';
     ...
     * @var string
     */
    protected $primaryKey = 'recommendeddocumentid';
}
