...
/**
* LeadCompetitors class
*
* LeadCompetitors entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class LeadCompetitors extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'leadcompetitorscollection';
     ...
     * @var string
     */
    protected $primaryKey = 'leadcompetitorid';
}
