...
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class TimeZoneDefinition extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'timezonedefinitions';
     ...
     * @var string
     */
    protected $primaryKey = 'timezonedefinitionid';
}
