...
*
* CompetitorSalesLiterature File
* PHP version 7
*
* @category  Library
...
/**
* CompetitorSalesLiterature class
*
* CompetitorSalesLiterature entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class CompetitorSalesLiterature extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'competitorsalesliteratures';
     ...
     * @var string
     */
    protected $primaryKey = 'competitorsalesliteratureid';
}
