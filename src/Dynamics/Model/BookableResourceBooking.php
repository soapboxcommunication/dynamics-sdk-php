...
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class BookableResourceBooking extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'bookableresourcebookings';
     ...
     * @var string
     */
    protected $primaryKey = 'bookableresourcebookingid';
}
