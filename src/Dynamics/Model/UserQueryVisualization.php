...
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class UserQueryVisualization extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'userqueryvisualizations';
     ...
     * @var string
     */
    protected $primaryKey = 'userqueryvisualizationid';
}
