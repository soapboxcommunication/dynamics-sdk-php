...
/**
* DuplicateRuleCondition class
*
* DuplicateRuleCondition entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class DuplicateRuleCondition extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'duplicateruleconditions';
     ...
     * @var string
     */
    protected $primaryKey = 'duplicateruleconditionid';
}
