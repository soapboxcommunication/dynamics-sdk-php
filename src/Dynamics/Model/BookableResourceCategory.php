...
/**
* BookableResourceCategory class
*
* BookableResourceCategory entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class BookableResourceCategory extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'bookableresourcecategories';
     ...
     * @var string
     */
    protected $primaryKey = 'bookableresourcecategoryid';
}
