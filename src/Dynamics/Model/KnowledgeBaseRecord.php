...
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class KnowledgeBaseRecord extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'knowledgebaserecords';
     ...
     * @var string
     */
    protected $primaryKey = 'knowledgebaserecordid';
}
