...
/**
* EntitlementProducts class
*
* EntitlementProducts entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class EntitlementProducts extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'entitlementproductscollection';
     ...
     * @var string
     */
    protected $primaryKey = 'entitlementproductid';
}
