...
/**
* BusinessUnitNewsArticle class
*
* BusinessUnitNewsArticle entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class BusinessUnitNewsArticle extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'businessunitnewsarticles';
     ...
     * @var string
     */
    protected $primaryKey = 'businessunitnewsarticleid';
}
