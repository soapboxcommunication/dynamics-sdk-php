...
/**
* BookableResourceGroup class
*
* BookableResourceGroup entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class BookableResourceGroup extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'bookableresourcegroups';
     ...
     * @var string
     */
    protected $primaryKey = 'bookableresourcegroupid';
}
