...
*
* EntitlementTemplateProducts File
* PHP version 7
*
* @category  Library
...
/**
* EntitlementTemplateProducts class
*
* EntitlementTemplateProducts entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class EntitlementTemplateProducts extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'entitlementtemplateproductscollection';
     ...
     * @var string
     */
    protected $primaryKey = 'entitlementtemplateproductid';
}
