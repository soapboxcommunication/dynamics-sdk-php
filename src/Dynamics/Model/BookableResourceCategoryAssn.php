...
*
* BookableResourceCategoryAssn File
* PHP version 7
*
* @category  Library
...
/**
* BookableResourceCategoryAssn class
*
* BookableResourceCategoryAssn entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class BookableResourceCategoryAssn extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'bookableresourcecategoryassns';
     ...
     * @var string
     */
    protected $primaryKey = 'bookableresourcecategoryassnid';
}
