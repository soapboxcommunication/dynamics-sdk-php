...
*
* msdyn_knowledgearticle_knowledgearticle File
* PHP version 7
*
* @category  Library
...
/**
* msdyn_knowledgearticle_knowledgearticle class
*
* msdyn_knowledgearticle_knowledgearticle entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class msdyn_knowledgearticle_knowledgearticle extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'msdyn_knowledgearticle_knowledgearticleset';
     ...
     * @var string
     */
    protected $primaryKey = 'msdyn_knowledgearticle_knowledgearticleid';
}
