...
/**
* SystemUserRoles class
*
* SystemUserRoles entity
*
* @category  Model
* @package   Microsoft.Dynamics
* @license   https://opensource.org/licenses/MIT MIT License
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class SystemUserRoles extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'systemuserrolescollection';
     ...
     * @var string
     */
    protected $primaryKey = 'systemuserroleid';
}
