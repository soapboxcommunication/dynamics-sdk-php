...
* @link      https://www.microsoft.com/en-us/dynamics365/
*/
class DynamicPropertyInstance extends Entity
{
     /**
     ...
     * @var string
     */
    protected $entity = 'dynamicpropertyinstances';
     ...
     * @var string
     */
    protected $primaryKey = 'dynamicpropertyinstanceid';
}
